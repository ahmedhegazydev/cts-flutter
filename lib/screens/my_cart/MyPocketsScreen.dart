        ...
        child: Column(
          children: [
            ...
            _buildSideMenuFolders(
                ...
                // "flagged".tr,
                "وارد للكل".tr,
                "assets/images/incoming_icon.png", false, 05),
            _buildSideMenuFolders(context,
                // "notifications".tr,
                "صادر للكل".tr,
                "assets/images/outgoing_icon.png", false, 19)
          ],
        ),
      ),
    );
...
class _ListView1State extends State<ListView1> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BasketController>(builder: (logic) {
      ...
      //             .toString() ??
      //         "");
      return logic.getBasketInboxModel==null?Center(child: CircularProgressIndicator(),) :
                                            ...
                                            children: [
                                              Container(
                                                  width: MediaQuery.of(
                                                      ...
                                                      .1,
                                                  child: Text(
                                                logic.   getBasketInboxModel!. correspondences![
                                                    pos]
                                                        .gridInfo?[
                                                    index]
                                                        .label ??
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      MainAxisAlignment
                                          .spaceBetween,
                                      children: [
                                        Icon( logic.getBasketInboxModel!.correspondences![pos]
                                            .isLocked!
                                            ? Icons.lock
                                            : Icons.lock_open),
                                        Container(
                                          ...
                                          width: 20,
                                          decoration: BoxDecoration(
                                              color:  logic.getBasketInboxModel!.correspondences![
                                              pos]
                                                  .priorityId ==
                                                  "1"
                                                  ? Colors.green
                                        ...
                                        Text( logic.getBasketInboxModel!.correspondences![pos]
                                            .fromUser ??
                                            ""),
                                        if ( logic.getBasketInboxModel!.correspondences![pos]
                                            .hasAttachments ??
                                            false)
                                                      ...
                                                      children: [
                                                        Row(
                                                            ...
                                                            children: [
                                                              Padding(
                                                                padding: const EdgeInsets.all(8.0),
                                                                child: Text( logic.getBasketInboxModel!.correspondences![pos].fromUser ?? ""),
                                                              ),
                                                              SizedBox(
                                                                width: 8,
                                                              ),
...
//Navigator.of(context).pop();
          ...
          itemCount:  logic.getBasketInboxModel!.correspondences!.length + 1);
    });
  }
}
