class RemoveItemsFromBasketRequest
{
  ...
  String language;
    ...
    RemoveItemsFromBasketRequest(
        {required this.token,required this.basketDocuments,required this.basketId,required this.language});
}
...
int ID ;
  ...
  int UserGctId ;
    ...
    BasketDocumentDto(
        {required this.DOC_ID,required this.ID, this.RegDate,required this.TSF_ID,required this.UserGctId});
