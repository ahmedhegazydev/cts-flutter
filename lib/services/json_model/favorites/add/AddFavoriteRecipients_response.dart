...
class AddFavoriteRecipientsResponse extends AbstractJsonResource {
  String? errorMessage;
  int? status;
  List<FavoriteRecipientsDto>? Recipients;

  AddFavoriteRecipientsResponse(
      {this.errorMessage, this.status, this.Recipients});

  AddFavoriteRecipientsResponse.fromJson(Map<String, dynamic> json) {
