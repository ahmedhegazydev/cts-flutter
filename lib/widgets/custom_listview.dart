                      ...
                      if (pos < correspondences.length) {
                        ...
                        return
                          ...
                          onTap: () {
                            ...
                            Get.find<DocumentController>().  gatAllDataAboutDOC(docId:   correspondences[pos].purposeId!,correspondenceId:   correspondences[pos].correspondenceId!,transferId:correspondences[pos].transferId! );
                            //  Get.find<DocumentController>().loadPdf();
                                                ...
                                                actions: <Widget>[
                                                  FlatButton(
                                                    onPressed: () async {
                                                      ...
                                                      //
                                                      // print("*" * 20);
                                                      // print(audioFileBes64);
                                                      //
                                                      // print(allCorrespondences[
                                                      //         pos]
                                                      //     .correspondenceId);
                                                      // print(Get.find<
                                                      //         InboxController>()
                                                      ...
                                                      //     replay =
                                                      //     ReplyWithVoiceNoteApi();
                                                      // ReplyWithVoiceNoteRequestModel replayModel = ReplyWithVoiceNoteRequestModel(
                                                      //     token: Get.find<
                                                      //             InboxController>()
                                                      //         .secureStorage
                                                      //         .token()!,
                                                      ...
                                                      //     voiceNote:
                                                      //         audioFileBes64);
// replayModel.voiceNote=audioFileBes64;
