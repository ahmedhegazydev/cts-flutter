...
class RemoveFavoriteRecipientsResponse extends AbstractJsonResource {
  String? errorMessage;
  int? status;
  List<FavoriteRecipientsDto>? Recipients;

  RemoveFavoriteRecipientsResponse(
      {this.errorMessage, this.status, this.Recipients});

  RemoveFavoriteRecipientsResponse.fromJson(Map<String, dynamic> json) {
