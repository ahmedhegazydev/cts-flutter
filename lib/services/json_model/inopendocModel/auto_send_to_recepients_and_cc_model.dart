...
class AutoSendToRecepientsAndCCModel extends AbstractJsonResource{
  String? errorMessage;
  int? status;
  String? cceds;
  String? ccedsTitle;
  ...
  AutoSendToRecepientsAndCCModel(
      {this.errorMessage,
        this.status,
        this.cceds,
        this.ccedsTitle,
  ...
  AutoSendToRecepientsAndCCModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.transferTo != null) {
      data['transferTo'] = this.transferTo!.toJson();
    }
